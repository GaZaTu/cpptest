...
public:
  ...
  public:
    ...
    virtual std::string createUpsertScript(const char* table, const orm::field_info* fields, size_t fields_len, const orm::field_info* idfields, size_t idfields_len) {
      throw db::sql_error{"not implemented"};
    }

    virtual std::string createInsertScript(const orm::query_builder_data& data) {
      throw db::sql_error{"not implemented"};
    }
    ...
    virtual std::string createUpsertScript(const orm::query_builder_data& data) {
      throw db::sql_error{"not implemented"};
    }
    ...
    virtual std::function<void(std::string_view)>& onPrepareStatement() {
